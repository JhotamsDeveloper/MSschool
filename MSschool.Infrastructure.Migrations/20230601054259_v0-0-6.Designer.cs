...
namespace MSschool.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20230601054259_v0-0-6")]
    partial class v006
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MSschool.Application.Domain.Models.Categories.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fd7b33cf-6796-4caf-82e1-c1f843e57ec9"),
                            Availability = true,
                            CreatedByIdUser = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2023, 6, 1, 0, 42, 59, 359, DateTimeKind.Unspecified).AddTicks(6914),
                            Description = "Persona que presta los servicios de docencia a la institución.",
                            Name = "Docente"
                        },
                        new
                        {
                            Id = new Guid("955487f9-517d-4e33-8e0a-0c8eefbbc646"),
                            Availability = true,
                            CreatedByIdUser = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2023, 6, 1, 0, 42, 59, 359, DateTimeKind.Unspecified).AddTicks(6947),
