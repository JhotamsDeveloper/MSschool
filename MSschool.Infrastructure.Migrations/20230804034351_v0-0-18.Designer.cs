...
namespace MSschool.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20230804034351_v0-0-18")]
    partial class v0018
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSschool.Application.Domain.Models.Categories.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a39f5311-119f-4dea-aafc-97184d35b099"),
                            Description = "Persona que presta los servicios de docencia a la institución.",
                            Name = "Docente"
                        },
                        new
                        {
                            Id = new Guid("f754fec6-a14f-4d18-adfd-e6eb6bd17eca"),
            ...
            modelBuilder.Entity("MSschool.Application.Domain.Models.Geolocation.Colombia", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
